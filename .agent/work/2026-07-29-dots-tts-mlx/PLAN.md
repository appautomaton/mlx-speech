...
**Gap-fix evidence:** Replaced the not-yet-live guide URL with the live `mlx-speech` repository URL (HTTP 200) and uploaded only the authoritative card to root `README.md` at revision `5dde9ded6c577a84a71b5ee9dafebfa53188d6d6`. Local and remote README SHA-256 are both `9a2bc58b54a34f95760665103d36ccb026939f1d497cf9249883c3bfd03b52c6`; the remote inventory remains 58 approved paths, and all 16 safetensors LFS SHA-256 values match artifact revision `0af7ad2f837278b364902500d086553f1586ce9a`. Four current-revision isolated-cache continuation smokes passed in `262.11 s`; focused release suite `9 passed`, final unit tier `737 passed`, Ruff and `git diff --check` passed.
