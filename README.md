...
| — | [NVIDIA Nemotron 3.5 ASR Streaming](https://github.com/appautomaton/mlx-speech/blob/main/docs/nemotron-asr.md) — cache-aware multilingual streaming, local bf16 build pending publication | local checkpoint |
