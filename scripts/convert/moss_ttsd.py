#!/usr/bin/env python3
"""Convert upstream MossTTSDelay safetensors into MLX-native int8 weights."""
...
from mlx_speech.checkpoints import INDEX_FILENAME
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default="models/openmoss/moss_ttsd/mlx-int8",
...
def main() -> None:
    ...
    if not report.is_exact_match:
        raise ValueError("Original TTSD checkpoint must align exactly before conversion.")
    ...
    print("Converted MossTTSDelay checkpoint")
