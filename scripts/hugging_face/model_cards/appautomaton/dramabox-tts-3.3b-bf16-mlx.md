...
- Upstream model: [`ResembleAI/Dramabox`](https://huggingface.co/ResembleAI/Dramabox)
- Foundation model: [`Lightricks/LTX-2.3`](https://huggingface.co/Lightricks/LTX-2.3)
